...
class ShapeGenerator:
    def __init__(self):
        ...
        self.vacancyPoint = self.vacancy #where is a point of the generated Shape,can't equal to zero
...
class Element(ShapeGenerator):
    ...
    #    pass
    def generateRandomElementForTest(self):
        pass
...
if __name__ == "__main__":
    ...
    cv=Canvas(60,100)
    ellipse=cv.generateShape("ellipse",16,30)
